...
@section('title', 'Chỉnh sửa kỹ năng')
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form form-vertical" name="addSkillForm"
                                                  ...
                                                  {{--                                                  action="{{ route('admin.edit-skill', $skill->id) }}"--}}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="first-name-vertical">Tên kỹ năng</label>
                                                                ...
                                                                >
                                                                <span class="text-danger">{{ $errors->first('skillName') }}</span>
                                                            </div>
                                                        </div>
