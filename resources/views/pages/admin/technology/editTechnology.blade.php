...
@section('title', 'Chỉnh sửa công nghệ')
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form form-vertical" name="addTechnologyForm"
                                                  id="addCompanyForm" method="POST"
                                                  action="{{ route('admin.edit-technology', $technology->id) }}"
