                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-process text-center mb-30">
                                ...
                                <div class="process-cap">
                                    ...
                                    <p>
                                        Tìm kiếm công việc phù hợp với bạn - Quy trình tìm kiếm công việc nhanh chóng rõ ràng, chính xác
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="single-process text-center mb-30">
                                ...
                                <div class="process-cap">
                                    <h5>2. Ứng tuyển</h5>
                                    <p>
                                        Ứng tuyển công việc phù hợp với bạn - Quy trình ứng tuyển công việc nhanh chóng rõ ràng, chính xác
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-process text-center mb-30">
                                ...
                                <div class="process-cap">
                                    <h5>3. Phỏng vấn</h5>
                                    <p>
                                        Phỏng vấn công việc phù hợp với bạn - Quy trình phỏng vấn công việc nhanh chóng rõ ràng, chính xác
                                    </p>
                                </div>
                            </div>
                        </div>
